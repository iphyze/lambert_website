...
if(isset($_GET['division']) && $_GET['division'] != ""){
    $division_name = mysqli_real_escape_string($db, $_GET['division']);
 }else{
...
<div class="all-projects-header">
    <div class="all-projects-overlay">
        ...
        <div class="all-projects-header-briefs wow fadeInUp">Search Result - <?php echo $_GET['division']; ?></div>
    </div>
</div>    
-->
...
<div class="all-projects-container">
    ...
    <div class="all-project-flexbox">
        ...
        $select = mysqli_query($db, "SELECT * FROM project_table WHERE project_division = '$division_name' ORDER BY id ASC");
        ...
        <div class="all-project-fb-col wow fadeInUp">
            ...
            <div class="apfb-col-textbox">
                ...
                <div class="apfb-col-location wow fadeInUp" data-wow-delay=".5s">
                    <?php if($project_division == "Power Generation and Transmission"){echo "Power Generation & Hybrid Solutions"; }else{echo $project_division; } ?>
                </div>
        ...
        <div class="apfb-col-textbox wow fadeInUp">No Projects Available for this division!</div>
